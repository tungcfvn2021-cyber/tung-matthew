...
const services: SeedService[] = [
  { slug: "low-fade", name: "Low Fade", category: "FADE", price: 90000, durationMin: 40, suitableFor: "Thích gọn gàng, chuyên nghiệp", sortOrder: 1 },
  { slug: "mid-fade", name: "Mid Fade", category: "FADE", price: 90000, durationMin: 40, suitableFor: "Cân bằng, hợp mọi khuôn mặt", sortOrder: 2 },
  { slug: "high-fade", name: "High Fade", category: "FADE", price: 90000, durationMin: 45, suitableFor: "Cá tính, trẻ trung", sortOrder: 3 },
  { slug: "taper-fade", name: "Taper Fade", category: "FADE", price: 90000, durationMin: 45, suitableFor: "Lịch sự, dễ chăm sóc", sortOrder: 4 },
  { slug: "undercut", name: "Undercut", category: "CUT", price: 90000, durationMin: 45, suitableFor: "Mạnh mẽ, nam tính", sortOrder: 5 },
  { slug: "mohican", name: "Mohican", category: "CUT", price: 90000, durationMin: 50, suitableFor: "Nổi bật, khác biệt", sortOrder: 6 },
  { slug: "buzz-cut", name: "Buzz Cut", category: "CUT", price: 90000, durationMin: 25, suitableFor: "Đơn giản, khỏe khoắn", sortOrder: 7 },
  { slug: "crew-cut", name: "Crew Cut", category: "CUT", price: 90000, durationMin: 30, suitableFor: "Cổ điển, gọn gàng", sortOrder: 8 },
  { slug: "french-crop", name: "French Crop", category: "CUT", price: 90000, durationMin: 40, suitableFor: "Hiện đại, dễ tạo kiểu", sortOrder: 9 },
  { slug: "textured-crop", name: "Textured Crop", category: "CUT", price: 90000, durationMin: 45, suitableFor: "Tóc dày, muốn phá cách", sortOrder: 10 },
  { slug: "pompadour", name: "Pompadour", category: "STYLING", price: 90000, durationMin: 50, suitableFor: "Phong cách quý ông", sortOrder: 11 },
  { slug: "quiff", name: "Quiff", category: "STYLING", price: 90000, durationMin: 50, suitableFor: "Lịch lãm, trẻ trung", sortOrder: 12 },
  { slug: "uon-toc", name: "Uốn tóc", category: "PERM", price: 270000, durationMin: 90, suitableFor: "Muốn tóc phồng, bồng bềnh", sortOrder: 13 },
  { slug: "ep-toc", name: "Ép tóc", category: "PERM", price: 250000, durationMin: 90, suitableFor: "Muốn tóc thẳng mượt, vào nếp", sortOrder: 14 },
  { slug: "nhuom-toc", name: "Nhuộm tóc", category: "COLOR", price: 279000, durationMin: 90, suitableFor: "Đổi màu cá tính", sortOrder: 15 },
  { slug: "tay-toc", name: "Tẩy tóc", category: "BLEACH", price: 200000, durationMin: 60, suitableFor: "Chuẩn bị nhuộm màu sáng", sortOrder: 16 },
  { slug: "cao-mat", name: "Cạo mặt", category: "SHAVE", price: 60000, durationMin: 20, suitableFor: "Da mặt sạch, thư giãn", sortOrder: 17 },
  { slug: "massage", name: "Massage đầu vai gáy", category: "MASSAGE", price: 80000, durationMin: 25, suitableFor: "Thư giãn sau cắt", sortOrder: 18 },
